		...
		if ($.isEmptyObject(course_dict) == false) {
			...
			for (var k in course_dict) {
				if (course_dict[k]['workload'] && (course_dict[k]['price'] !== 0)) {
					$("#main-search-div").append("<div class=\"filtered media well\"><div class=\"media-left media-middle\"><img class=\"media-object\" src=" + course_dict[k]['picture'] + " alt=\"course pic\"></div><div class=\"media-body\"><a id=\"course-url\" href=" + course_dict[k]['url'] + " target =\"_blank\"><h4 class=\"media-heading\">" + course_dict[k]['title'] + "</h4><p>" + course_dict[k]['description'].slice(0,350) + "</p><p>Workload: " + course_dict[k]['workload'] + "<br>Price: $" + course_dict[k]['price'] + "</p></a><button class =\"btn btn-danger favorite-button btn-xs\" type=\"button\" id=" + k + ">Favorite</button> <button class=\"btn btn-success taken-button btn-xs\" id=" + k + ">Taken</button> <button class=\"btn btn-success enrolled-button btn-xs\" id=" + k + ">Enrolled</button><p id=\"btn-response-msg-" + k + "\"></p></div></div>");
				} else if (course_dict[k]['workload'] && (course_dict[k]['price'] === 0)) {
					$("#main-search-div").append("<div class=\"filtered media well\"><div class=\"media-left media-middle\"><img class=\"media-object\" src=" + course_dict[k]['picture'] + " alt=\"course pic\"></div><div class=\"media-body\"><a id=\"course-url\" href=" + course_dict[k]['url'] + " target =\"_blank\"><h4 class=\"media-heading\">" + course_dict[k]['title'] + "</h4><p>" + course_dict[k]['description'].slice(0,350) + "</p><p>Workload: " + course_dict[k]['workload'] + "<br>Price: Free</p></a><button class =\"btn btn-danger favorite-button btn-xs\" type=\"button\" id=" + k + ">Favorite</button> <button class=\"btn btn-success taken-button btn-xs\" id=" + k + ">Taken</button> <button class=\"btn btn-success enrolled-button btn-xs\" id=" + k + ">Enrolled</button><p id=\"btn-response-msg-" + k + "\"></p></div></div>");
				} else if (!(course_dict[k]['workload']) && (course_dict[k]['price'] !== 0)) {
					$("#main-search-div").append("<div class=\"filtered media well\"><div class=\"media-left media-middle\"><img class=\"media-object\" src=" + course_dict[k]['picture'] + " alt=\"course pic\"></div><div class=\"media-body\"><a id=\"course-url\" href=" + course_dict[k]['url'] + " target =\"_blank\"><h4 class=\"media-heading\">" + course_dict[k]['title'] + "</h4><p>" + course_dict[k]['description'].slice(0,350) + "</p><p>Price: $" + course_dict[k]['price'] + "</p></a><button class =\"btn btn-danger favorite-button btn-xs\" type=\"button\" id=" + k + ">Favorite</button> <button class=\"btn btn-success taken-button btn-xs\" id=" + k + ">Taken</button> <button class=\"btn btn-success enrolled-button btn-xs\" id=" + k + ">Enrolled</button><p id=\"btn-response-msg-" + k + "\"></p></div></div>");
				} else if (!(course_dict[k]['workload']) && (course_dict[k]['price'] === 0)) {
					$("#main-search-div").append("<div class=\"filtered media well\"><div class=\"media-left media-middle\"><img class=\"media-object\" src=" + course_dict[k]['picture'] + " alt=\"course pic\"></div><div class=\"media-body\"><a id=\"course-url\" href=" + course_dict[k]['url'] + " target =\"_blank\"><h4 class=\"media-heading\">" + course_dict[k]['title'] + "</h4><p>" + course_dict[k]['description'].slice(0,350) + "</p><p>Price: Free</p></a><button class =\"btn btn-danger favorite-button btn-xs\" type=\"button\" id=" + k + ">Favorite</button> <button class=\"btn btn-success taken-button btn-xs\" id=" + k + ">Taken</button> <button class=\"btn btn-success enrolled-button btn-xs\" id=" + k + ">Enrolled</button><p id=\"btn-response-msg-" + k + "\"></p></div></div>");
				};
